...
require (
	...
	github.com/intel/afxdp-plugins-for-kubernetes/libraries/goclient v0.0.0-00010101000000-000000000000
...
replace github.com/intel/afxdp-plugins-for-kubernetes/libraries/goclient => ./libraries/goclient
